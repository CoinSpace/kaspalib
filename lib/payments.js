...
import { Address, ADDRESS_VERSION } from './address.js';
import { abytes, isBytes, PUBKEY_TYPES, validatePubkey } from './utils.js';
...
export function p2pkECDSA(pubkey) {
  return {
    type: 'pk-ecdsa',
